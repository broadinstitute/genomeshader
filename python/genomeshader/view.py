...
class GenomeShader:
    ...
    def show_old(self,
        ...
        df = df.with_columns(
            pl.when(df['element_type'] == 0).then(pl.lit('gray'))
              .when((df['element_type'] == 1) & (df['sequence'] == 'A')).then(pl.lit('green'))
              .when((df['element_type'] == 1) & (df['sequence'] == 'C')).then(pl.lit('blue'))
              .when((df['element_type'] == 1) & (df['sequence'] == 'G')).then(pl.lit('orange'))
              .when((df['element_type'] == 1) & (df['sequence'] == 'T')).then(pl.lit('red'))
              .when(df['element_type'] == 2).then(pl.lit('purple'))
              .when(df['element_type'] == 3).then(pl.lit('black'))
              .when((df['element_type'] == 4) & (df['sequence'] == 'A')).then(pl.lit('green'))
              .when((df['element_type'] == 4) & (df['sequence'] == 'C')).then(pl.lit('blue'))
              .when((df['element_type'] == 4) & (df['sequence'] == 'G')).then(pl.lit('orange'))
              .when((df['element_type'] == 4) & (df['sequence'] == 'T')).then(pl.lit('red'))
